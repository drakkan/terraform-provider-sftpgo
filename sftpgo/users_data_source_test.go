	...
	user1 := client.User{
		...
		Filters: client.UserFilters{
			BaseUserFilters: client.BaseUserFilters{
				...
				WebClient: []string{"shares-require-email-auth", "shares-policy-change-disabled",
				...
				AllowedSharePaths: []string{"/projects", "/partners"},
				DeniedSharePaths:  []string{"/private", "/logs"},
				DeniedShareScopes: []string{"write"},
			},
		...
		Steps: []resource.TestStep{
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.sftpgo_users.test", "users.0.filters.web_client.#", "5"),
					resource.TestCheckResourceAttr("data.sftpgo_users.test", "users.0.filters.web_client.0", "shares-require-email-auth"),
					resource.TestCheckResourceAttr("data.sftpgo_users.test", "users.0.filters.web_client.1", "shares-policy-change-disabled"),
					resource.TestCheckResourceAttr("data.sftpgo_users.test", "users.0.filters.web_client.2", "wopi-disabled"),
					resource.TestCheckResourceAttr("data.sftpgo_users.test", "users.0.filters.web_client.3", "rest-api-disabled"),
					resource.TestCheckResourceAttr("data.sftpgo_users.test", "users.0.filters.web_client.4", sdk.WebClientInfoChangeDisabled),
					...
					resource.TestCheckResourceAttr("data.sftpgo_users.test", "users.0.filters.allowed_share_paths.#", "2"),
					resource.TestCheckResourceAttr("data.sftpgo_users.test", "users.0.filters.allowed_share_paths.0", "/projects"),
					resource.TestCheckResourceAttr("data.sftpgo_users.test", "users.0.filters.allowed_share_paths.1", "/partners"),
					resource.TestCheckResourceAttr("data.sftpgo_users.test", "users.0.filters.denied_share_paths.#", "2"),
					resource.TestCheckResourceAttr("data.sftpgo_users.test", "users.0.filters.denied_share_paths.0", "/private"),
					resource.TestCheckResourceAttr("data.sftpgo_users.test", "users.0.filters.denied_share_paths.1", "/logs"),
					resource.TestCheckResourceAttr("data.sftpgo_users.test", "users.0.filters.denied_share_scopes.#", "1"),
					resource.TestCheckResourceAttr("data.sftpgo_users.test", "users.0.filters.denied_share_scopes.0", "write"),
