						...
						"options": schema.SingleNestedAttribute{
							...
							Attributes: map[string]schema.Attribute{
								...
								"retention_config": schema.SingleNestedAttribute{
									...
									Attributes: map[string]schema.Attribute{
										"source_folder": schema.StringAttribute{
											Computed:    true,
											Description: "Virtual folder name. When set, the retention check runs once as a system task on this folder. " + enterpriseFeatureNote + ".",
										},
										...
										"split_reports": schema.BoolAttribute{
											Computed:    true,
											Description: "Generate individual retention reports per user, allowing one notification per user. " + enterpriseFeatureNote + ".",
										},
								...
								"fs_config": schema.SingleNestedAttribute{
									...
									Attributes: map[string]schema.Attribute{
											...
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													...
													"on_source_copied_move_path": schema.StringAttribute{
														Computed:    true,
														Description: "Destination directory for moved sources. Required when on_source_copied is 2. " + enterpriseFeatureNote + ".",
													},
													"max_retries": schema.Int64Attribute{
														Computed:    true,
														Description: "Number of retry attempts per file. 0 means no retry. " + enterpriseFeatureNote + ".",
													},
												},
											},
										},
										"continue_on_error": schema.BoolAttribute{
											Computed:    true,
											Description: "Continue processing remaining files after a failure instead of stopping at the first error. Currently supported for copy actions only. " + enterpriseFeatureNote + ".",
										},
								...
								"event_report_config": schema.SingleNestedAttribute{
									Computed:    true,
									Description: "Event report action configurations. " + enterpriseFeatureNote + ".",
									Attributes: map[string]schema.Attribute{
										...
										"fs_actions": schema.ListAttribute{
											ElementType: types.StringType,
											Computed:    true,
											Description: "Filter events by filesystem action. If empty, all actions are included.",
										},
