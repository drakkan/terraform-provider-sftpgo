		...
		Settings: client.RoleSettings{
			StorageAllowlist: client.RoleStorageAllowlist{
				...
				SFTP: client.SFTPRoleScope{
					...
					AllowedProxies: []string{"socks5://127.0.0.1:1080"},
				},
		...
		Steps: []resource.TestStep{
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.sftpgo_roles.test", "roles.0.settings.storage_allowlist.sftp.allowed_proxies.0", "socks5://127.0.0.1:1080"),
