		...
		Steps: []resource.TestStep{
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.sftpgo_groups.test", "groups.0.user_settings.filters.web_client.#", "4"),
					...
					resource.TestCheckResourceAttr("data.sftpgo_groups.test", "groups.0.user_settings.filters.web_client.3",
						client.EnterpriseWebClientOptions[3]),
					...
					resource.TestCheckResourceAttr("data.sftpgo_groups.test", "groups.0.user_settings.filters.denied_share_scopes.0", "read_write"),
					...
					resource.TestCheckResourceAttr("data.sftpgo_groups.test", "groups.0.user_settings.filesystem.gcsconfig.universe_domain", "googleapis.com"),
					resource.TestCheckNoResourceAttr("data.sftpgo_groups.test", "groups.0.user_settings.filesystem.sftpconfig"),
					resource.TestCheckNoResourceAttr("data.sftpgo_groups.test", "groups.0.user_settings.filesystem.httpconfig"),
					resource.TestCheckResourceAttr("data.sftpgo_groups.test", "groups.0.virtual_folders.#", "1"),
