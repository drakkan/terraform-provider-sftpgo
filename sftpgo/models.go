...
func (u *userResourceModel) toSFTPGo(ctx context.Context) (*client.User, diag.Diagnostics) {
	...
	if !u.PasswordWo.IsNull() {
		user.Password = u.PasswordWo.ValueString()
	}
...
type s3FsConfig struct {
	...
	AccessSecretWoVersion   types.Int64  `tfsdk:"access_secret_wo_version"`
	SSECustomerKey          types.String `tfsdk:"sse_customer_key"`
	SSECustomerKeyWo        types.String `tfsdk:"sse_customer_key_wo"`
	SSECustomerKeyWoVersion types.Int64  `tfsdk:"sse_customer_key_wo_version"`
...
type azBlobFsConfig struct {
	...
	AccountKeyWoVersion types.Int64  `tfsdk:"account_key_wo_version"`
	SASURL              types.String `tfsdk:"sas_url"`
	SASURLWo            types.String `tfsdk:"sas_url_wo"`
	SASURLWoVersion     types.Int64  `tfsdk:"sas_url_wo_version"`
	Endpoint            types.String `tfsdk:"endpoint"`
	KeyPrefix           types.String `tfsdk:"key_prefix"`
	UploadPartSize      types.Int64  `tfsdk:"upload_part_size"`
	UploadConcurrency   types.Int64  `tfsdk:"upload_concurrency"`
...
type sftpFsConfig struct {
	...
	KeyPassphraseWoVersion  types.Int64  `tfsdk:"key_passphrase_wo_version"`
	...
	SocksPasswordWoVersion  types.Int64  `tfsdk:"socks_password_wo_version"`
}
	...
	return map[string]attr.Type{
		...
		"s3config": types.ObjectType{
			AttrTypes: map[string]attr.Type{
				...
				"access_secret_wo_version":    types.Int64Type,
				"sse_customer_key":            types.StringType,
				"sse_customer_key_wo":         types.StringType,
				"sse_customer_key_wo_version": types.Int64Type,
		...
		"gcsconfig": types.ObjectType{
			AttrTypes: map[string]attr.Type{
				...
				"credentials_wo_version": types.Int64Type,
		...
		"azblobconfig": types.ObjectType{
			AttrTypes: map[string]attr.Type{
				...
				"account_key_wo_version": types.Int64Type,
				"sas_url":                types.StringType,
				"sas_url_wo":             types.StringType,
				"sas_url_wo_version":     types.Int64Type,
				"endpoint":               types.StringType,
				"key_prefix":             types.StringType,
				"upload_part_size":       types.Int64Type,
				"upload_concurrency":     types.Int64Type,
		...
		"sftpconfig": types.ObjectType{
			AttrTypes: map[string]attr.Type{
				...
				"key_passphrase_wo_version": types.Int64Type,
				...
				"socks_password_wo_version": types.Int64Type,
			},
		},
		...
		"httpconfig": types.ObjectType{
			AttrTypes: map[string]attr.Type{
				...
				"api_key_wo_version":  types.Int64Type,
				"skip_tls_verify":     types.BoolType,
				"equality_check_mode": types.Int64Type,
			},
		},
...
func (f *filesystem) toSFTPGo(ctx context.Context) (client.Filesystem, diag.Diagnostics) {
	...
	fs := client.Filesystem{
		...
		S3Config: sdk.S3FsConfig{
			...
			AccessSecret:   getSFTPGoSecret(getSecretValue(f.S3Config.AccessSecret, f.S3Config.AccessSecretWo)),
			SSECustomerKey: getSFTPGoSecret(getSecretValue(f.S3Config.SSECustomerKey, f.S3Config.SSECustomerKeyWo)),
		},
		GCSConfig: client.GCSFsConfig{
			...
			Credentials: getSFTPGoSecret(getSecretValue(f.GCSConfig.Credentials, f.GCSConfig.CredentialsWo)),
		},
		AzBlobConfig: sdk.AzBlobFsConfig{
			...
			AccountKey: getSFTPGoSecret(getSecretValue(f.AzBlobConfig.AccountKey, f.AzBlobConfig.AccountKeyWo)),
			SASURL:     getSFTPGoSecret(getSecretValue(f.AzBlobConfig.SASURL, f.AzBlobConfig.SASURLWo)),
		},
		CryptConfig: sdk.CryptFsConfig{
			Passphrase: getSFTPGoSecret(getSecretValue(f.CryptConfig.Passphrase, f.CryptConfig.PassphraseWo)),
		...
		SFTPConfig: client.SFTPFsConfig{
			...
			Password:      getSFTPGoSecret(getSecretValue(f.SFTPConfig.Password, f.SFTPConfig.PasswordWo)),
			PrivateKey:    getSFTPGoSecret(getSecretValue(f.SFTPConfig.PrivateKey, f.SFTPConfig.PrivateKeyWo)),
			KeyPassphrase: getSFTPGoSecret(getSecretValue(f.SFTPConfig.KeyPassphrase, f.SFTPConfig.KeyPassphraseWo)),
			SocksPassword: getSFTPGoSecret(getSecretValue(f.SFTPConfig.SocksPassword, f.SFTPConfig.SocksPasswordWo)),
		},
		FTPConfig: client.FTPFsConfig{
			Endpoint:      f.FTPConfig.Endpoint.ValueString(),
			Username:      f.FTPConfig.Username.ValueString(),
			Password:      getSFTPGoSecret(getSecretValue(f.FTPConfig.Password, f.FTPConfig.PasswordWo)),
		...
		HTTPConfig: sdk.HTTPFsConfig{
			...
			Password: getSFTPGoSecret(getSecretValue(f.HTTPConfig.Password, f.HTTPConfig.PasswordWo)),
			APIKey:   getSFTPGoSecret(getSecretValue(f.HTTPConfig.APIKey, f.HTTPConfig.APIKeyWo)),
		},
	}
...
func (a *adminResourceModel) toSFTPGo(ctx context.Context) (*client.Admin, diag.Diagnostics) {
	...
	if !a.PasswordWo.IsNull() {
		admin.Password = a.PasswordWo.ValueString()
	}
...
func (o *eventActionOptions) toSFTPGo(ctx context.Context) (client.EventActionOptions, diag.Diagnostics) {
	...
	options := client.EventActionOptions{
		HTTPConfig: client.EventActionHTTPConfig{
			...
			Password:      getSFTPGoSecret(getSecretValue(o.HTTPConfig.Password, o.HTTPConfig.PasswordWo)),
			PrivateKey:    getSFTPGoSecret(getSecretValue(o.HTTPConfig.PrivateKey, o.HTTPConfig.PrivateKeyWo)),
			Passphrase:    getSFTPGoSecret(getSecretValue(o.HTTPConfig.Passphrase, o.HTTPConfig.PassphraseWo)),
		...
		FsConfig: client.EventActionFilesystemConfig{
			...
			PGP: client.EventActionPGP{
				...
				Password:   getSFTPGoSecret(getSecretValue(o.FsConfig.PGP.Password, o.FsConfig.PGP.PasswordWo)),
				PrivateKey: getSFTPGoSecret(getSecretValue(o.FsConfig.PGP.PrivateKey, o.FsConfig.PGP.PrivateKeyWo)),
				Passphrase: getSFTPGoSecret(getSecretValue(o.FsConfig.PGP.Passphrase, o.FsConfig.PGP.PassphraseWo)),
		...
		IMAPConfig: client.EventActionIMAPConfig{
			...
			Password: getSFTPGoSecret(getSecretValue(o.IMAPConfig.Password, o.IMAPConfig.PasswordWo)),
			...
			OAuth2: client.OAuth2Config{
				...
				ClientSecret: getSFTPGoSecret(getSecretValue(o.IMAPConfig.OAuth2.ClientSecret, o.IMAPConfig.OAuth2.ClientSecretWo)),
				RefreshToken: getSFTPGoSecret(getSecretValue(o.IMAPConfig.OAuth2.RefreshToken, o.IMAPConfig.OAuth2.RefreshTokenWo)),
			},
...
func (o *eventActionOptions) fromSFTPGo(ctx context.Context, action *client.BaseEventAction) diag.Diagnostics {
	...
	case client.ActionTypeHTTP:
		o.HTTPConfig = &eventActionHTTPConfig{
			...
			PrivateKey:    getOptionalString(getSecretFromSFTPGo(action.Options.HTTPConfig.PrivateKey)),
			Passphrase:    getOptionalString(getSecretFromSFTPGo(action.Options.HTTPConfig.Passphrase)),
...
func (r *licenseResourceModel) toSFTPGo(_ context.Context) (*client.License, diag.Diagnostics) {
	license := &client.License{
		Key:       getSecretValue(r.Key, r.KeyWo),
...
func getSecretValue(val, valWo types.String) string {
	if !valWo.IsNull() {
		return valWo.ValueString()
	}
