...
- `tls_verification` (Boolean) Enable or disable TLS verification for the SFTPGo API. Set to false to disable TLS verification (e.g., for self-signed certificates). May also be provided via SFTPGO_TLS_VERIFICATION environment variable.
