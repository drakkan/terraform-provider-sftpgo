...
<a id="nestedatt--user_settings--filesystem--gcsconfig--credentials"></a>
...
- `private_key` (Attributes) (see [below for nested schema](#nestedatt--user_settings--filesystem--sftpconfig--private_key))
